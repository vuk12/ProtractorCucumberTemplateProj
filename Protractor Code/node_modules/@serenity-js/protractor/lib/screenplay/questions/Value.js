...
class Value extends core_1.Question {
     ...
     */
    constructor(target) {
        super((0, io_1.formatted) `the value of ${target}`);
        this.target = target;
    }
    /**
     * @param {Question<ElementFinder> | ElementFinder} target
     ...
     */
    answeredBy(actor) {
        return (0, withAnswerOf_1.withAnswerOf)(actor, this.target, (elf) => abilities_1.BrowseTheWeb.as(actor).executeFunction(
