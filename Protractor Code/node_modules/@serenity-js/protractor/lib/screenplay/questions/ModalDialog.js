...
class ModalDialog {
     ...
     */
    static hasPoppedUp() {
        return core_1.Question.about(`the modal dialog has popped up`, actor => (0, promiseOf_1.promiseOf)(abilities_1.BrowseTheWeb.as(actor).alert()).then(() => true, error => {
            // Based on:
     ...
     */
    static message() {
        return core_1.Question.about(`the modal dialog message`, actor => (0, promiseOf_1.promiseOf)(abilities_1.BrowseTheWeb.as(actor).alert().getText()));
    }
}
