...
class TargetNestedElement extends core_1.Question {
     ...
     */
    answeredBy(actor) {
        return (0, withAnswerOf_1.withAnswerOf)(actor, this.parent, parent => (0, withAnswerOf_1.withAnswerOf)(actor, this.child, child => (0, override_1.override)(parent.element(child.locator()), 'toString', TargetNestedElement.prototype.toString.bind(this))));
    }
}
