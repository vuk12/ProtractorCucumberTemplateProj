...
class RightClick extends core_1.Interaction {
     ...
     */
    performAs(actor) {
        return (0, withAnswerOf_1.withAnswerOf)(actor, this.target, (elf) => abilities_1.BrowseTheWeb.as(actor).actions().mouseMove(elf).perform()).then(() => abilities_1.BrowseTheWeb.as(actor).actions().click(protractor_1.protractor.Button.RIGHT).perform());
    }
    /**
     * @desc
     ...
     */
    toString() {
        return (0, io_1.formatted) `#actor right clicks on ${this.target}`;
    }
}
