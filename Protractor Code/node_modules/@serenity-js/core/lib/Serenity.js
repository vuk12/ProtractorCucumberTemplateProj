    ...
    configure(config) {
        ...
        if (Array.isArray(config.crew)) {
            this.stage.assign(...config.crew.map((stageCrewMember, i) => {
                ...
                throw new errors_1.ConfigurationError((0, io_1.formatted) `Entries under \`crew\` should implement either StageCrewMember or StageCrewMemberBuilder interfaces, \`${stageCrewMember}\` found at index ${i}`);
            }));
        }
    }
    /**
